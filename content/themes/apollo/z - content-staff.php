                                    ...
                                    ?>
                                        <div class="col-md-3 content-area" id="main-column"><? php echo get_the_post_thumbnail( $page->ID, 'thumbnail' ); ?><br/>
                                            <ul class="social-links list-inline">
                                                ...
                                                <li><a href="<?php the_field('staff_linkedin')?>" target="_blank"><img src="/prototype/images/linkedin.png"></a></li>
                                                <li><a href="<?php the_field('staff_twitter')?> target="_blank"><img src="/prototype/images/twitter.png"></a></li>
                                            </ul>
                                        </div>
