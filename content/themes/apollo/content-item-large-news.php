...
?>                    <div class="item large">
                        ...
                        <div class="item-text">
                            ...
                            <?php if (get_field('blog_author')) echo '<div class="metadata">'.'Author: '.get_field('blog_author').'</div>'?>
                            <!--<p class="metadata"><?php //echo get_the_date("m/d/Y") ?>, <a href="/news">News</a> / <?php //echo $theme_list ?></p>-->
                            <?php the_excerpt() ?>
